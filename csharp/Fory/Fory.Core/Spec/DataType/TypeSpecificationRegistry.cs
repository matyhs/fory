...
namespace Fory.Core.Spec.DataType
{
    internal class TypeSpecificationRegistry
    {
        ...
        public enum KnownTypes : ushort
        {
            ...
            /// <summary>
            /// a data type consisting of a set of named values. Rust enum with non-predefined field values are not supported as an enum.
            /// </summary>
            Enum = 13,
            ...
            /// <summary>
            /// a morphic(final) type serialized by Fory Struct serializer. i.e. it doesn't have subclasses. Suppose we're deserializing List&lt;SomeClass&gt;, we can save dynamic serializer dispatch since SomeClass is morphic(final).
            /// </summary>
            Struct = 15,
            ...
            /// <summary>
            /// a point in time, independent of any calendar/timezone, as a count of nanoseconds. The count is relative to an epoch at UTC midnight on January 1, 1970.
            /// </summary>
            Timestamp = 25,
            ...
            /// <summary>
            /// only allow 1d numeric components. Other arrays will be taken as List. The implementation should support the interoperability between array and list.
            /// </summary>
            Array = 29,
